...
from flask import Flask, jsonify, abort, make_response, render_template, request, redirect, url_for, send_from_directory
...
class AttachmentAPI(Resource):
    ...
    def get(self, id):
        ...
        return send_from_directory(os.path.join(os.getcwd(), app.config["UPLOAD_FOLDER"]), attachment.identity)
